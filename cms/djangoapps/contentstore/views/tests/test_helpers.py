...
class HelpersTestCase(CourseTestCase):
    def test_xblock_studio_url(self):
        # Verify course URL
        self.assertEqual(xblock_studio_url(self.course), u'/course/MITx.999.Robot_Super_Course/branch/published/block/Robot_Super_Course')
        ...
        # Verify lesson URL
        sequential = ItemFactory.create(parent_location=chapter.location, category='sequential', display_name="Lesson 1")
        ...
        child_vertical = ItemFactory.create(parent_location=vertical.location, category='vertical', display_name='Child Vertical')
        self.assertEqual(xblock_studio_url(child_vertical), u'/container/MITx.999.Robot_Super_Course/branch/published/block/Child_Vertical')
