...
class BasicAssetsTestCase(AssetsTestCase):
    ...
    def test_CMS_url_generation(self):
        url = StaticContent.get_url_path_from_location(location)
        self.assertEquals(url, '/i4x/foo/bar/asset/my_file_name.jpg')

    def test_LMS_url_generation(self):
        url = TEST_LMS_BASE + StaticContent.get_url_path_from_location(location)
